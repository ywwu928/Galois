...
public:
  ...
  GluonSubstrate(
    ...
    galois::runtime::reportStat_Single(RNAME, "SendCommBufferUsage", comm_buffer_size);
    galois::runtime::reportStat_Single(RNAME, "RecvCommBufferUsage", comm_buffer_size);
  }
