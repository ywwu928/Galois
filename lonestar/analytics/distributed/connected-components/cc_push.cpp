...
constexpr static const char* const name = "Distributed Connected Components (Push)";
constexpr static const char* const desc = "Distributed Connected Components (Push)";
