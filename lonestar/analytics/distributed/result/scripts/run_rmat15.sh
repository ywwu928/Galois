...
# srun -N 1 -n 8 $program "$graph/rmat15.gr" -graphTranspose="$graph/rmat15.tgr" -startNode=662666 -t=16 --runs=1 -partition=iec --exec=Sync -statFile="$result/rmat15_8procs_stat" > "$result/rmat15_8procs"
# srun -N 1 -n 16 $program "$graph/rmat15.gr" -graphTranspose="$graph/rmat15.tgr" -startNode=662666 -t=8 --runs=1 -partition=iec --exec=Sync -statFile="$result/rmat15_16procs_stat" > "$result/rmat15_16procs"
# srun -N 1 -n 32 $program "$graph/rmat15.gr" -graphTranspose="$graph/rmat15.tgr" -startNode=662666 -t=4 --runs=1 -partition=iec --exec=Sync -statFile="$result/rmat15_32procs_stat" > "$result/rmat15_32procs"
# srun -N 1 -n 64 $program "$graph/rmat15.gr" -graphTranspose="$graph/rmat15.tgr" -startNode=662666 -t=2 --runs=1 -partition=iec --exec=Sync -statFile="$result/rmat15_64procs_stat" > "$result/rmat15_64procs"
