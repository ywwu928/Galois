...
# srun -N 2 -n 128 $program "$graph/yelp.gr" -graphTranspose="$graph/yelp.tgr" -t=2 --runs=1 -partition=iec --exec=Sync -statFile="$result/yelp_128procs_stat" > "$result/yelp_128procs"
...
# srun -N 4 -n 128 $program "$graph/data_200.gr" -graphTranspose="$graph/data_200.tgr" -t=3 --runs=1 -partition=oec --exec=Sync -statFile="$result/data_200_128procs_stat" > "$result/data_200_128procs"
