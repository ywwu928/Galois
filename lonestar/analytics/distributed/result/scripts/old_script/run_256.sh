...
result="/work/08474/ywwu/ls6/Galois/lonestar/analytics/distributed/result/bfs/balanced_nodes/oec"

srun -N 8 -n 256 $program "$graph/data_200.gr" -graphTranspose="$graph/data_200.tgr" -t=3 --runs=1 -partition=oec --exec=Sync -statFile="$result/data_200_256procs_stat" > "$result/data_200_256procs"
