...
# srun -N 1 -n 8 $program "$graph/yelp.gr" -graphTranspose="$graph/yelp.tgr" -startNode=662666 -t=16 --runs=1 -partition=oec --exec=Sync -statFile="$result/yelp_8procs_stat" > "$result/yelp_8procs"
# srun -N 1 -n 16 $program "$graph/yelp.gr" -graphTranspose="$graph/yelp.tgr" -startNode=662666 -t=8 --runs=1 -partition=oec --exec=Sync -statFile="$result/yelp_16procs_stat" > "$result/yelp_16procs"
# srun -N 1 -n 32 $program "$graph/yelp.gr" -graphTranspose="$graph/yelp.tgr" -startNode=662666 -t=4 --runs=1 -partition=oec --exec=Sync -statFile="$result/yelp_32procs_stat" > "$result/yelp_32procs"
srun -N 1 -n 64 $program "$graph/yelp.gr" -graphTranspose="$graph/yelp.tgr" -startNode=662666 -t=2 --runs=1 -partition=oec --exec=Sync -statFile="$result/yelp_64procs_stat" > "$result/yelp_64procs"
