...
# srun -N 1 -n 8 $program "$graph/flickr.gr" -graphTranspose="$graph/flickr.tgr" -startNode=662666 -t=16 --runs=1 -partition=iec --exec=Sync -statFile="$result/flickr_8procs_stat" > "$result/flickr_8procs"
# srun -N 1 -n 16 $program "$graph/flickr.gr" -graphTranspose="$graph/flickr.tgr" -startNode=662666 -t=8 --runs=1 -partition=iec --exec=Sync -statFile="$result/flickr_16procs_stat" > "$result/flickr_16procs"
# srun -N 1 -n 32 $program "$graph/flickr.gr" -graphTranspose="$graph/flickr.tgr" -startNode=662666 -t=4 --runs=1 -partition=iec --exec=Sync -statFile="$result/flickr_32procs_stat" > "$result/flickr_32procs"
# srun -N 1 -n 64 $program "$graph/flickr.gr" -graphTranspose="$graph/flickr.tgr" -startNode=662666 -t=2 --runs=1 -partition=iec --exec=Sync -statFile="$result/flickr_64procs_stat" > "$result/flickr_64procs"
