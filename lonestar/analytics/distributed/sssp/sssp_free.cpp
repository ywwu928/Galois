    ...
    void static go(Graph& _graph) {
        ...
        do {
            ...
            if (odd) {
                ...
                syncSubstrate->poll_for_remote_work_bitset<Reduce_min_dist>(bitset_dist_current_even);
                StatTimer_comm.stop();
                ...
                StatTimer_comm.start();
                _net.flushCommunication();
                syncSubstrate->poll_for_remote_work_bitset<Reduce_min_dist>(bitset_dist_current_odd);
                StatTimer_comm.stop();
