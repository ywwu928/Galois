...
struct BFSPullRemote {
  ...
  BFSPullRemote(Graph* _graph, galois::DynamicBitSet* _active_bitset_ptr)
      : graph(_graph),
  ...
  void static go(Graph& _graph, galois::DynamicBitSet* _active_bitset_ptr) {
      ...
      galois::do_all(
          galois::iterate(remoteNodes), BFSPullRemote{&_graph, _active_bitset_ptr},
...
struct BFSPullMaster {
  Graph* graph;
  
  galois::DynamicBitSet* active_bitset_ptr;
  galois::DynamicBitSet* dirty_bitset_ptr;

  BFSPullMaster(Graph* _graph, galois::DynamicBitSet* _active_bitset_ptr, galois::DynamicBitSet* _dirty_bitset_ptr)
      : graph(_graph),
        active_bitset_ptr(_active_bitset_ptr),
  ...
  void static go(Graph& _graph, galois::DynamicBitSet* _active_bitset_ptr, galois::DynamicBitSet* _dirty_bitset_ptr) {
      ...
      galois::do_all(
          galois::iterate(masterNodes), BFSPullMaster{&_graph, _active_bitset_ptr, _dirty_bitset_ptr},
          galois::steal(), galois::no_stats());
  }
...
struct BFSPush {
  ...
  BFSPush(Graph* _graph, galois::DynamicBitSet* _active_bitset_ptr, galois::DynamicBitSet* _dirty_bitset_ptr)
      : graph(_graph),
        active_bitset_ptr(_active_bitset_ptr),
        dirty_bitset_ptr(_dirty_bitset_ptr),
        net(galois::runtime::getSystemNetworkInterface()) {}
  ...
  void static go(Graph& _graph, galois::DynamicBitSet* _active_bitset_ptr, galois::DynamicBitSet* _dirty_bitset_ptr) {
      ...
      galois::do_all(
          galois::iterate(masterNodes), BFSPush(&_graph, _active_bitset_ptr, _dirty_bitset_ptr),
    ...
    do {
      ...
      if (pull) {
          if (odd) {
              ...
              BFSPullRemote::go(_graph, &bitset_dist_current_odd);
              _net.flushRemoteWork();
              BFSPullMaster::go(_graph, &bitset_dist_current_odd, &bitset_dist_current_even);
              ...
              StatTimer_compute.start();
              BFSPullRemote::go(_graph, &bitset_dist_current_even);
              _net.flushRemoteWork();
              BFSPullMaster::go(_graph, &bitset_dist_current_even, &bitset_dist_current_odd);
              StatTimer_compute.stop();
          ...
          if (odd) {
              ...
              StatTimer_compute.start();
              BFSPush::go(_graph, &bitset_dist_current_odd, &bitset_dist_current_even);
              _net.flushRemoteWork();
              StatTimer_compute.stop();
              ...
              StatTimer_compute.start();
              BFSPush::go(_graph, &bitset_dist_current_even, &bitset_dist_current_odd);
              _net.flushRemoteWork();
              StatTimer_compute.stop();
...
constexpr static const char* const name = "Distributed Breadth-First Search (Hybrid)";
constexpr static const char* const desc = "Distributed Breadth-First Search (Hybrid)";
