# Install script for directory: /work/08474/ywwu/ls6/Galois/lonestar/analytics/cpu/bipart
...
if(CMAKE_INSTALL_COMPONENT STREQUAL "apps")
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/bin" TYPE EXECUTABLE FILES "/work/08474/ywwu/ls6/Galois/lonestar/analytics/cpu/bipart/bipart-cpu")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/bipart-cpu" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/bin/bipart-cpu")
